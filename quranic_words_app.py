...
quranic_words = [
 ...
 {"Word (Arabic)": "سَلاَم", "Transliterati on": "Salam", "Meaning": "Peace", "Example": "فَسَلَّمُوٓا۟ عَلَيْهِمْ بِسَلاَمٍۢ (Greet them with peace)"},
 ...
 {"Word (Arabic)": "والدة", "Transliteratio n": "Walidah", "Meaning": "Mother", "Example": "فِيٓ بُيُوتِهِۦ (In their homes)"},
 ...
 {"Word (Arabic)": "حقيقة", "Transliteratio n": "Haqiqah", "Meaning": "Reality, Truth", "Example": "إِنَّ حَقَّ ٱلۡمَرْءِ فِي (Indeed, the truth of a person in)"},
 ...
 {"Word (Arabic)": "مبارك", "Transliteratio n": "Mubarak", "Meaning": "Blessed", "Example": "وَجَعَلۡنَٰهُۥ مُبَٰرَكٖا (And We made him blessed)"},
 ...
 {"Word (Arabic)": "مستقيم", "Transliterati on": "Mustaqim", "Meaning": "Straight, Upright", "Example": "ٱهْدِنَا ٱلصِّرَٰطَ ٱلْمُسْتَقِيمَ (Guide us to the straight path)"},
 ...
 {"Word (Arabic)": "خيرات", "Transliteratio n": "Khairat", "Meaning": "Good deeds, Charity", "Example": "إِنَّ ٱللَّهَ بِغَفْرٍۢ مِنْهُ وَرَحْمَةٍۢ (Indeed, Allah is forgiving and merciful)"},
 ...
 {"Word (Arabic)": "عافية", "Transliteratio n": "Afiya", "Meaning": "Health, Well-being", "Example": "اللّهُمَّ بَارِكْ لِي فِي عَافِيَتِى (O Allah, bless me in my well-being)"},
 {"Word (Arabic)": "عدالة", "Transliteratio n": "Adalah", "Meaning": "Justice, Fairness", "Example": "إِنَّ ٱللَّهَ يَأْمُرُكُم بِالۡعَدْلِ (Indeed, Allah commands you to act justly)"},
 ...
 {"Word (Arabic)": "سلطان", "Transliteratio n": "Sultan", "Meaning": "Authority, Power", "Example": "إِنَّ ٱللَّهَ لَا يَظْلِمُ ٱحَدًۭا فِى سُلۡطَٰنِهِۦ (Indeed, Allah does not wrong anyone in His dominion)"},
 ...
 {"Word (Arabic)": "عبادة", "Transliteratio n": "Ibadah", "Meaning": "Worship", "Example": "وَمَآ خَلَقْتُ الْجِنَّ وَالإِنسَ إِلَّا لِيَعْبُدُونِ (And I did not create the jinn and mankind except to worship Me)"},
 ...
 {"Word (Arabic)": "هداية", "Transliteratio n": "Hidayah", "Meaning": "Guidance", "Example": "إِنَّ عَلَيْنَا لِلْهُدَىٰ (Indeed, upon Us is guidance)"},
 ...
 {"Word (Arabic)": "نوايا", "Transliteratio n": "Nawaya", "Meaning": "Intention", "Example": "إِنَّمَآ ٱلْأَعْمَٰلُ بِالنِّيَّاتِ (Indeed, actions are by intentions)"},
 ...
 {"Word (Arabic)": "مفتاح", "Transliteratio n": "Miftah", "Meaning": "Key", "Example": "وَفَجَّرْنَا ٱلۡمَعَٰنِ فَجَّرْنَا فَجًّۭا (And We caused the fountains to gush)"},
 ...
 {"Word (Arabic)": "مائدة", "Transliteratio n": "Ma’idah", "Meaning": "Table, Feast", "Example": "إِذْ قَالَ الْحَوَارِيُّونَ يَا عِيسَىٰ (When the disciples said, 'O Jesus')"},
 {"Word (Arabic)": "ضيافة", "Transliteratio n": "Diyafah", "Meaning": "Hospitality", "Example": "فَذُوقُوا۟ بِمَا كُنتُمْ تَكْسِبُونَ (Taste the punishment for what you used to earn)"},
 {"Word (Arabic)": "محراب", "Transliteratio n": "Mihrab", "Meaning": "Sanctuary, Niche", "Example": "وَدَخَلَ الْمِحْرَابَ فَصَلَّىٰ (And he entered the sanctuary and prayed)"},
 {"Word (Arabic)": "سعي ", "Transliteration" : "Sa’y", "Meaning": "Effort", "Example": "إِنَّ سَعْيَكُمْ لَشَتَّىٰ (Indeed, your efforts are diverse)"},
 {"Word (Arabic)": "إيمان", "Transliteratio n": "Iman", "Meaning": "Faith, Belief", "Example": "إِنَّمَآ أَمَٰنَكُمْ إِذَآ آمَنُوا۟ (Indeed, the true believers are those who believe in Allah)"},
 ...
 {"Word (Arabic)": "مؤمنون", "Transliterati on": "Mu’minun", "Meaning": "Believers", "Example": "إِنَّ ٱلۡمُؤْمِنِينَ وَٱلۡمُؤْمِنَٰتِ (Indeed, the believing men and believing women)"},
 ...
 {"Word (Arabic)": "إجابة", "Transliteratio n": "Ijabah", "Meaning": "Response, Answer", "Example": "وَإِذَا سَأَلَكَ عِبَادِى عَنِّىۚ (And when My servants ask you concerning Me)"},
 {"Word (Arabic)": "رسالة", "Transliteratio n": "Risalah", "Meaning": "Message", "Example": "إِنَّمَآ أُو۟حِىٓ إِلَىٰٓ (Indeed, I am sent only as a messenger)"},
 ...
 {"Word (Arabic)": "أمانة", "Transliteratio n": "Amanah", "Meaning": "Trust, Deposit", "Example": "إِنَّ ٱللَّهَ يَأْمُرُكُمْ أَنْ تُؤَدُّوا۟ ٱلْأَمَٰنَٰتِ (Indeed, Allah commands you to return trusts)"},
 ...
 {"Word (Arabic)": "شهادة", "Transliteratio n": "Shahadah", "Meaning": "Testimony, Witness", "Example": "شَهِدَ اللَّهُ أَنَّهُۥ لَآ إِلٰهَ إِلَّا هُوَ (Allah bears witness that there is no god but Him)"},
 ...
 {"Word (Arabic)": "سلامة", "Transliteratio n": "Salamah", "Meaning": "Safety, Health", "Example": "فَسَلِّمُوا۟ عَلَيْهِمْ بِسَلاَمٍۢ (Then greet them with a greeting of peace)"},
 ...
 {"Word (Arabic)": "مغفرة", "Transliteratio n": "Maghfirah", "Meaning": "Forgiveness", "Example": "فَٱغْفِرْ لِىٰ إِنَّكَ أَنتَ ٱلْغَفُورُ (So forgive me, indeed, You are the Forgiving)"},
