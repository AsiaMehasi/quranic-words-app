...
quranic_words = [
    ...
    {"Word (Arabic)": "كتاب", "Transliteration": "Kitab", "Meaning": "Book", "Example": "تِلۡكَ أٓيَٰتُ ٱلۡكِتَٰبِ (These are the verses of the Book)"},
    ...
    {"Word (Arabic)": "قلب", "Transliteration": "Qalb", "Meaning": "Heart", "Example": "لَهُمۡ قُلُوبٞ لَّا يَفۡقَهُونَ بِهَا (They have hearts with which they do not understand)"},
    ...
    {"Word (Arabic)": "قلب", "Transliteration": "Qalb", "Meaning": "Heart", "Example": "إِلَّا مَنۡ أَتَى ٱللَّهَ بِقَلۡبٖ سَلِيمٖ (Except he who comes to Allah with a sound heart)"},
    ...
    {"Word (Arabic)": "كتاب", "Transliteration": "Kitab", "Meaning": "Book", "Example": "يُحِبُّونَ ٱلۡجُمُودَ لِفَتَحِهِۦ لِكَ لَا إِلَٰهَ إِلَّا هُوَ (They love the book of Allah, and to Him is all praise)"},
    ...
    {"Word (Arabic)": "قلب", "Transliteration": "Qalb", "Meaning": "Heart", "Example": "وَأَمَّا قُلُوبُهُمۡ فَمَفْتُوحَةٌ (And their hearts are opened)"},
    ...
    {"Word (Arabic)": "قلب", "Transliteration": "Qalb", "Meaning": "Heart", "Example": "إِنَّ ٱللَّهَ عَلَىٰ قُلُوبِهِۦۦ (Indeed, Allah is on their hearts)"},
