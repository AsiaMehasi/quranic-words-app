...
quranic_words = [
 ...
 {"Word (Arabic)": "عن" , "Transliteration": "An", "Meaning": "About, Concerning, From", "Example": "عَن سَبِيلِ ٱللَّهِ (From the path of Allah)"},
 ...
 {"Word (Arabic)": "باب ", "Transliteration" : "Bab", "Meaning": "Door", "Example": "وَقَالَ ٱدۡخُلُوا۟ ٱلۡبَابَ سُجَّدًۭا (And He said, 'Enter the door in prostration' - Surah Al-Baqarah, 2:58)"},
 {"Word (Arabic)": "قبة ", "Transliteration" : "Qubba", "Meaning": "Dome", "Example": "تَحْتَ قُبَّتِهِۦ (Under his dome)"},
 {"Word (Arabic)": "سقف ", "Transliteration" : "Saqf", "Meaning": "Roof", "Example": "وَجَعَلۡنَا ٱلسَّمَآءَ سَقۡفًۭا مَّحۡفُوظًۭا (And We made the sky a protected ceiling - Surah Al-Anbiya, 21:32)"},
 {"Word (Arabic)": "شجرة", "Transliteration": "Shajarah", "Meaning": "Tree", "Example": "وَشَجَرَةً۬ تَخۡرُجُ مِن طُورِ سَيۡنَآءَ (And a tree that grows out of Mount Sinai - Surah Al-Mu’minun, 23:20)"},
 {"Word (Arabic)": "ريح ", "Transliteration" : "Rih", "Meaning": "Wind", "Example": "وَفِى عَادٍ إِذۡ أَرۡسَلۡنَا عَلَيۡهِمُ ٱلرِّيحَ ٱلۡعَقِيمَ (And in [the case of] 'Aad, when We sent against them the barren wind - Surah Adh-Dhariyat, 51:41)"},
 {"Word (Arabic)": "صوت ", "Transliteration" : "Sawt", "Meaning": "Voice, Sound", "Example": "إِنَّ أَنكَرَ ٱلۡأَصۡوَٲتِ لَصَوۡتُ ٱلۡحَمِيرِ (Indeed, the most disagreeable of sounds is the voice of donkeys - Surah Luqman, 31:19)"},
 {"Word (Arabic)": "رسول", "Transliteration": "Rasul", "Meaning": "Messenger", "Example": "وَمَا مُحَمَّدٌ إِلَّا رَسُولٌۭ (And Muhammad is not but a messenger - Surah Aal-E-Imran, 3:144)"},
 ...
 {"Word (Arabic)": "رجاء", "Transliteration": "Raja'", "Meaning": "Hope", "Example": "مَّن كَانَ يَرۡجُواْ لِقَآءَ ٱللَّهِ (Whoever hopes for the meeting with Allah - Surah Al-Ankabut, 29:5)"},
 {"Word (Arabic)": "سوء ", "Transliteration" : "Su'", "Meaning": "Evil, Harm", "Example": "وَيَخَافُونَ سُوٓءَ ٱلۡحِسَابِ (And they fear the evil of [His] account - Surah Ar-Ra'd, 13:21)"},
 {"Word (Arabic)": "وقت ", "Transliteration" : "Waqt", "Meaning": "Time", "Example": "إِنَّ ٱلصَّلَوٰةَ كَانَتۡ عَلَى ٱلۡمُؤۡمِنِينَ كِتَٰبًۭا مَّوۡقُوتًۭا (Indeed, prayer has been decreed upon the believers a decree of specified times - Surah An-Nisa, 4:103)"},
 {"Word (Arabic)": "صوم ", "Transliteration" : "Sawm", "Meaning": "Fasting", "Example": "كُتِبَ عَلَيۡكُمُ ٱلصِّيَامُ (Fasting has been decreed upon you - Surah Al-Baqarah, 2:183)"},
 ...
 {"Word (Arabic)": "كفر ", "Transliteration" : "Kufr", "Meaning": "Disbelief", "Example": "إِنَّ ٱلَّذِينَ كَفَرُواْ (Indeed, those who disbelieve - Surah Al-Baqarah, 2:6)"},
 {"Word (Arabic)": "طهور", "Transliteration": "Tuhur", "Meaning": "Purity", "Example": "وَثِيَابَكَ فَطَهِّرۡ (And purify your garments - Surah Al-Muddathir, 74:4)"},
 ...
 {"Word (Arabic)": "حقيقة", "Transliteration": "Haqiqah", "Meaning": "Reality, Truth", "Example": "بَلْ كَانَتۡ مَعَٰهِمْ حَقِيقَةًۭ فَأَكَلُوا۟ (But the reality was with them, and they ate - Surah Al-Jathiya, 45:13)"},
 ...
 {"Word (Arabic)": "طاهر", "Transliteration": "Taher", "Meaning": "Pure, Clean", "Example": "وَيُحِبُّ ٱلۡمُطَّهِّرِينَۥ (And He loves those who purify themselves)"},
 {"Word (Arabic)": "مصير", "Transliteration": "Maseer", "Meaning": "Destination, Fate", "Example": "إِنَّ إِلَىٰ رَبِّكَ ٱلۡمَصِيرَ (Indeed, to your Lord is the final destination - Surah Al-Qiyamah, 75:30)"},
 ...
 {"Word (Arabic)": "قدوس", "Transliteration": "Quddus", "Meaning": "The Holy", "Example": " ٱلۡمَلِكُ ٱلۡقُدُّوسُ ٱلسَّلَٰمُ (The King, the Holy, the Peace)"},
 ...
 {"Word (Arabic)": "جليل", "Transliteration": "Jalil", "Meaning": "Majestic", "Example": "ذُو ٱلۡجَلَٰلِ وَٱلۡإِكۡرَامِ (Possessor of Majesty and Honor)"},
 ...
 {"Word (Arabic)": "طريق", "Transliteration": "Tariq", "Meaning": "Path, Way", "Example": "وَأَنَّ هَٰذَا صِرَٰطِي مُسۡتَقِيمٗا (And that this is My straight path)"},
 {"Word (Arabic)": "توبة", "Transliteration": "Tawbah", "Meaning": "Repentance", "Example": "وَهُوَ ٱلَّذِي يَقۡبَلُ ٱلتَّوۡبَةَ عَنۡ عِبَادِهِۦ (And He is the One who accepts repentance from His servants)"},
 ...
 {"Word (Arabic)": "عبد ", "Transliteration" : "Abd", "Meaning": "Servant, Worshipper", "Example": "وَمَا خَلَقۡتُ ٱلۡجِنَّ وَٱلۡإِنسَ إِلَّا لِيَعۡبُدُونِ (And I did not create jinn and mankind except to worship Me)"},
 {"Word (Arabic)": "سميع", "Transliteration": "Sami", "Meaning": "All-Hearing", "Example": "إِنَّ ٱللَّهَ سَمِيعٌۭ بِمَا يَفْعَلُونَ (Indeed, Allah is All-Hearing of what they do)"},
 ...
 {"Word (Arabic)": "فقر ", "Transliteration" : "Faqr", "Meaning": "Poverty", "Example": "إِنَّمَا الصَّدَقَٰتُ لِلۡفُقَرَاءِ وَٱلۡمَسَٰكِينِ (Indeed, the alms are for the poor and the needy - Surah At-Tawbah, 9:60)"},
 ...
 {"Word (Arabic)": "رزق ", "Transliteration" : "Rizq", "Meaning": "Provision, Sustenance", "Example": "إِنَّ ٱللَّهَ هُوَ ٱلرَّزَّاقُ ذُو ٱلۡقُوَّةِ ٱلۡمَتِينُ (Indeed, Allah is the Provider, the firm possessor of strength)"},
 {"Word (Arabic)": "حسن ", "Transliteration" : "Husn", "Meaning": "Goodness, Excellence", "Example": "إِنَّمَآ يُؤْمِنُونَ بِالْحَسَنَاتِ وَالْمَعْرُوفِ (Indeed, they only believe in goodness and what is right - Surah Al-Baqarah, 2:177)"},
 ...
 {"Word (Arabic)": "لطف ", "Transliteration" : "Lutf", "Meaning": "Kindness, Gentleness", "Example": "وَكَانَ اللَّٰهُ لَطِيفًۭا بِعِبَادِهِۦ (And Allah is gentle with His servants - Surah Ash-Shura, 42:19)"},
 ...
 {"Word (Arabic)": "عزة ", "Transliteration" : "Izzah", "Meaning": "Honor, Glory", "Example": "وَلِلَّهِ ٱلۡعِزَّةُ جَمِيعًا (And to Allah belongs all honor)"},
 ...
 {"Word (Arabic)": "مفتاح", "Transliteration": "Miftah", "Meaning": "Key", "Example": "وَعِندَهُۥ مَفَاتِحُ ٱلۡغَيۡبِ (And with Him are the keys of the unseen)"},
 ...
 {"Word (Arabic)": "بر" , "Transliteration": "Birr", "Meaning": "Righteousness", "Example": "وَبِرًّا بِوَالِدَيْهِا (And [I am] dutiful to my parents - Surah Maryam, 19:14)"},
 ...
 {"Word (Arabic)": "مائدة", "Transliteration": "Ma’idah", "Meaning": "Table, Feast", "Example": "ٱللَّهُمَّ ٱنْزِلۡ عَلَيۡنَا مَآئِدَةًۭ مِّنَ ٱلسَّمَآءِ (O Allah, send down to us a table spread with food from the heavens)"},
 {"Word (Arabic)": "ضيافة", "Transliteration": "Diyafah", "Meaning": "Hospitality", "Example": "هَلْ أَتَىٰكَ حَدِيثُ ضَيْفِ إِبْرَٰهِيمَ (Has the story reached you of the guests of Abraham?)"},
 ...
 {"Word (Arabic)": "رغبة", "Transliteration": "Raghbah", "Meaning": "Desire, Wish", "Example": "وَفَجَّرْنَا ٱلۡأَرۡضَ عُيُونًۭا فَٱلۡتَقَى ٱلۡمَآءُ عَلَىٰٓ أَمۡرٍۢ قَدَرٍۢ (And We caused the earth to gush forth with springs, so the waters met for a matter already predestined)"},
 ...
 {"Word (Arabic)": "كلمة", "Transliteration": "Kalima", "Meaning": "Word, Statement", "Example": "وَقُلۡنَا لَهُۥٓ كَلِمَةًۭۚ (And We gave him a word of truth and a word of life - Surah Al-An'am, 6:92)"},
